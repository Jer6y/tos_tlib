...
uint8_t             k_mmheap_default_pool[TOS_CFG_MMHEAP_DEFAULT_POOL_SIZE] __attribute__((aligned(4)));
#endif
...
uint8_t             k_stack_pool[TOS_CFG_TLIB_KSTACK_POOL_SIZE] __attribute__((aligned(4)));
k_mmblk_pool_t      k_mmblk_kernel_stk_ctl;
#endif
