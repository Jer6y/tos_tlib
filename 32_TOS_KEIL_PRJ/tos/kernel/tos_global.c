...
uint8_t             k_mmheap_default_pool[TOS_CFG_MMHEAP_DEFAULT_POOL_SIZE] __attribute__((aligned(4))) __attribute__((section("RAM_AREA")));
#endif
...
k_task_t*   	TCBS[MAX_TASK_AMOUNT]															;

uint8_t				tcb_bit_map[(MAX_TASK_AMOUNT>>3)+1]								;
